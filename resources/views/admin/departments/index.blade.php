...
<div class="bg-white rounded-lg shadow p-6">
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex gap-5">
            ...
            <a href="{{ route('fss.departments.index') }}" class="bg-black text-white px-4 py-2 rounded hover:bg-slate-800">
                Lihat Detail
            </a>
        </div>
            ...
            @foreach($departments as $dept)
                <tr class="border-b text-sm">
                    ...
                    <td class="py-2 text-right">
                        <a href="{{ route('departments.show', ["id" => $dept->id]) }}">Lihat</a>
                        <a href="{{ route('departments.edit', ["id" => $dept->id]) }}">Update</a>
                        <form action="{{ route('departments.destroy', ["id" => $dept->id]) }}" method="POST"> 
                            @csrf
                            @method('DELETE')
